...
class SampleLotInfo(EmbeddedDocument):
    ...
    planned_test_date = fields.StringField(max_length=20)  # Date as string (YYYY-MM-DD format)
    dimension_spec = fields.StringField(max_length=200)  # Dimension specifications
    request_by = fields.StringField(max_length=100, required=True)
...
class SamplePreparation(Document):
    ...
    """
    request_no = fields.StringField(max_length=100, unique=True, required=True)
